...
> Capacity to create a Container App Environment per region · automatically updated on **2026-07-10 15:29 UTC**.
...
| 🔴 Error | `southafricanorth` | ERROR: (InternalServerError) Internal server error occurred. correlation ID: 425b777d-b7af-4abd-bc3f-be1cf07f5f4a |
