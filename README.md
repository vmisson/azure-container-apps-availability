...
> Capacity to create a Container App Environment per region · automatically updated on **2026-09-05 18:43 UTC**.
...
| :--- | :--- | :--- |
| 🔴 Error | `austriaeast` | ERROR: The command failed with an unexpected error. Here is the traceback: ERROR: Expecting property name enclosed in double quotes: line 1 column 2 (char 1) Traceback (most recent call last): File /" |
