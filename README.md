...
> Capacity to create a Container App Environment per region · automatically updated on **2026-09-19 06:42 UTC**.
...
| 🔴 Error | `australiasoutheast` | ERROR: (InternalServerError) Internal server error occurred. correlation ID: d6c7cbd9-6d1a-488f-b88a-42f279051b2c |
