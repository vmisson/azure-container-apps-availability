...
> Capacity to create a Container App Environment per region · automatically updated on **2026-08-24 16:33 UTC**.
...
| 🔴 Error | `chilecentral` | ERROR: (InternalServerError) Internal server error occurred. correlation ID: bc020db1-759a-417a-96d7-08b402e02b3a |
