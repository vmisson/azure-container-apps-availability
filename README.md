...
> Capacity to create a Container App Environment per region · automatically updated on **2026-07-03 18:29 UTC**.
...
| 🔴 Error | `centralus` | ERROR: (InternalServerError) Internal server error occurred. correlation ID: a7f4b5b5-47a2-4d78-b888-35ec50936fed |
