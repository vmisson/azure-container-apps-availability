...
> Capacity to create a Container App Environment per region · automatically updated on **2026-07-13 19:40 UTC**.
...
| 🔴 Error | `spaincentral` | / Running .. \| Running .. \ Running .. - Running .. / Running ..ERROR: The command failed with an unexpected error. Here is the traceback: ERROR: Expecting property name enclosed in double quotes: li |
