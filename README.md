...
> Capacity to create a Container App Environment per region · automatically updated on **2026-08-25 03:42 UTC**.
...
| 🟣 Timeout | `malaysiawest` | exceeded 900s |
| 🟣 Timeout | `southeastasia` | exceeded 900s |
