...
> Capacity to create a Container App Environment per region · automatically updated on **2026-09-23 14:41 UTC**.
...
| 🔴 Error | `australiasoutheast` | ERROR: (GatewayTimeout) The gateway did not receive a response from 'Microsoft.App' within the specified time period. |
