...
> Capacity to create a Container App Environment per region · automatically updated on **2026-07-16 04:41 UTC**.
...
| 🔴 Error | `westus` | ERROR: (ManagedEnvironmentAllocationError) Failed to allocate managed environment. Please try again. |
