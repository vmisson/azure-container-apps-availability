...
> Capacity to create a Container App Environment per region · automatically updated on **2026-09-04 07:43 UTC**.
...
| :--- | :--- | :--- |
| 🔴 Error | `newzealandnorth` | ERROR: (GatewayTimeout) The gateway did not receive a response from 'Microsoft.App' within the specified time period. |
