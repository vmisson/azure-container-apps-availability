...
> Capacity to create a Container App Environment per region · automatically updated on **2026-08-14 02:31 UTC**.
...
| 🔴 Error | `australiaeast` | / Running .. \| Running .. \ Running .. - Running .. / Running ..ERROR: The command failed with an unexpected error. Here is the traceback: ERROR: Expecting property name enclosed in double quotes: li |
